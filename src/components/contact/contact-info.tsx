...
export function ContactInfo() {
  return (
    <aside className="rounded-3xl bg-warm-50 p-6 sm:p-8">
      <h2 className="font-display text-3xl text-ink-900">Coordonnées</h2>
      ...
      <ul className="mt-6 space-y-4">
        <li className="flex gap-3 text-ink-700">
          ...
          <div>
            ...
            <p className="text-sm text-ink-500">Interventions : {SITE_COVERAGE}</p>
